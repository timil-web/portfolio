...
const About = () => {
  return (
	<div id='About' className="text-white md:flex overflow-hidden items-center md:flex-wrap md:justify-center bg-[#121525] shadow-xl mx-0 md:mx-20 rounded-lg p-12">
		<div>
